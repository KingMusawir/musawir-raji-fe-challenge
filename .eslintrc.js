...
module.exports = {
  ...
  rules: {
    ...
    'react/prop-types': 'off',
    semi: ['error', 'never'],
    '@typescript-eslint/no-explicit-any': 'warn', // Changed to warn instead of 0
    '@typescript-eslint/no-unused-vars': [
    ...
    'react-hooks/rules-of-hooks': 'error', // Re-enabled since it catches real bugs
    'react-hooks/exhaustive-deps': 'warn',  // Re-enabled as warning
  },
  settings: {
    react: {
      version: 'detect',
